...
func (x XiGua) ParseShareUrl(shareUrl string) (*models.VideoParseInfo, error) {
	client := resty.New()
...
func (x XiGua) ParseVideoID(videoId string) (*models.VideoParseInfo, error) {
	...
	parseRes := &models.VideoParseInfo{
		Title:    videoDesc,
		VideoUrl: videoAddr,
		CoverUrl: coverUrl,
	}
